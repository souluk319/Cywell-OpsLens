...
- Generate the external runtime images plan and collect vLLM/Qdrant source digest, mirror digest, SBOM, provenance, license/support review, security approval, and release approval evidence before any runtime image mirror/sign step.
