...
| Command | Result | Note |
| --- | --- | --- |
| `npm run verify:web-shell` | PASS | 0 fail, 42 checks after the assistant ready-state, Korean navigation-action, release/action queue, and external runtime review label lanes |
